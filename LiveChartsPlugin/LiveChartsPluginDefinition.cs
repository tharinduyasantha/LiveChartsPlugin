using LiveChartsPlugin.Admin;
using LiveChartsPlugin.Background;
using LiveChartsPlugin.Client;
using System;
...
namespace LiveChartsPlugin
{
    ...
    /// </summary>
    public class LiveChartsPluginDefinition : PluginDefinition
    {
        private static System.Drawing.Image _treeNodeImage;
        private static System.Drawing.Image _topTreeNodeImage;

        internal static Guid LiveChartsPluginPluginId = new Guid("89a190de-f3f9-428f-bdc9-1e32a12abc7e");
        internal static Guid LiveChartsPluginKind = new Guid("0cd759c5-37ad-41e4-b7c0-e4993809a58f");
        internal static Guid LiveChartsPluginSidePanel = new Guid("b4f7469a-a4f6-47bc-a8a4-910c96dd4962");
        internal static Guid LiveChartsPluginViewItemPlugin = new Guid("fdf9e729-a434-4935-83a7-54c25fb08e51");
        internal static Guid LiveChartsPluginSettingsPanel = new Guid("7b5bab19-b14d-4875-aa53-3caf1507e95e");
        internal static Guid LiveChartsPluginBackgroundPlugin = new Guid("cf417cf2-59f3-4642-9423-701cdfde0829");
        internal static Guid LiveChartsPluginWorkSpacePluginId = new Guid("e348dd23-1687-4eb5-810a-a032d097fdb6");
        internal static Guid LiveChartsPluginWorkSpaceViewItemPluginId = new Guid("83c79dae-ec77-41a9-a167-a58e9ead7a58");
        internal static Guid LiveChartsPluginTabPluginId = new Guid("6ff8b7d4-f009-48de-8db2-5a6d62776227");
        internal static Guid LiveChartsPluginViewLayoutId = new Guid("94235de9-7eb1-4153-9975-6eceb8ab0e41");
        ...
        internal static Guid LiveChartsPluginWorkSpaceToolbarPluginId = new Guid("22222222-2222-2222-2222-222222222222");
        internal static Guid LiveChartsPluginViewItemToolbarPluginId = new Guid("33333333-3333-3333-3333-333333333333");
        internal static Guid LiveChartsPluginToolsOptionDialogPluginId = new Guid("44444444-4444-4444-4444-444444444444");
        ...
        private List<ViewLayout> _viewLayouts = new List<ViewLayout> { new LiveChartsPluginViewLayout() };
        ...
        /// Load resources 
        /// </summary>
        static LiveChartsPluginDefinition()
        {
        ...
        public override void Init()
        {
            ...
            _itemNodes.Add(new ItemNode(LiveChartsPluginKind, Guid.Empty,
                                         "LiveChartsPlugin", _treeNodeImage,
                                         "LiveChartsPlugins", _treeNodeImage,
                                         Category.Text, true,
                                         ItemsAllowed.Many,
                                         new LiveChartsPluginItemManager(LiveChartsPluginKind),
                                         null
                                         ));
            if (EnvironmentManager.Instance.EnvironmentType == EnvironmentType.SmartClient)
            {
                _workSpacePlugins.Add(new LiveChartsPluginWorkSpacePlugin());
                //_sidePanelPlugins.Add(new LiveChartsPluginSidePanelPlugin());
                _viewItemPlugins.Add(new LiveChartsPluginViewItemPlugin());
                _viewItemPlugins.Add(new LiveChartsPluginWorkSpaceViewItemPlugin());
                //_viewItemToolbarPlugins.Add(new LiveChartsPluginViewItemToolbarPlugin());
                //_workSpaceToolbarPlugins.Add(new LiveChartsPluginWorkSpaceToolbarPlugin());
        ...
        public override Guid Id
        {
            get
            {
                return LiveChartsPluginPluginId;
            }
        }
