...
namespace LiveChartsPlugin.Background
{
    /// <summary>
    ...
    /// </summary>
    public class LiveChartsPluginBackgroundPlugin : BackgroundPlugin
    {
        ...
        {
            get { return LiveChartsPluginDefinition.LiveChartsPluginBackgroundPlugin; }
        }
        ...
        {
            get { return "LiveChartsPlugin BackgroundPlugin"; }
        }
        ...
        public override void Init()
        {
            ...
            _thread.Name = "LiveChartsPlugin Background Thread";
            _thread.Start();
        ...
        private void Run()
        {
            EnvironmentManager.Instance.Log(false, "LiveChartsPlugin background thread", "Now starting...", null);
            while (!_stop)
            {
                // Do some work here.
            ...
            EnvironmentManager.Instance.Log(false, "LiveChartsPlugin background thread", "Now stopping...", null);
            _thread = null;
        }
    }
}
