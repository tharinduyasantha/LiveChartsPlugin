...
namespace LiveChartsPlugin.Admin
{
    ...
    /// </summary>
    public class LiveChartsPluginItemManager : ItemManager
    {
        private LiveChartsPluginUserControl _userControl;
        private Guid _kind;

        #region Constructors

        public LiveChartsPluginItemManager(Guid kind) : base()
        {
            _kind = kind;
        }
        ...
        {
            _userControl = new LiveChartsPluginUserControl();
        ...
        {
            return new LiveChartsPluginAddUserControl();
        }
        ...
        public override bool ValidateAndSaveUserControl()
        {
            if (CurrentItem != null)
            {
                ...
                Configuration.Instance.SaveItemConfiguration(LiveChartsPluginDefinition.LiveChartsPluginPluginId, CurrentItem);
            }
            return true;
        }
        ...
        {
            CurrentItem = new Item(suggestedFQID, ((LiveChartsPluginAddUserControl)addUserControl).ItemName);
            Configuration.Instance.SaveItemConfiguration(LiveChartsPluginDefinition.LiveChartsPluginPluginId, CurrentItem);
            return CurrentItem;
        }
        ...
        public override void DeleteItem(Item item)
        {
            if (item != null)
            {
                Configuration.Instance.DeleteItemConfiguration(LiveChartsPluginDefinition.LiveChartsPluginPluginId, item);
            }
        ...
        public override List<Item> GetItems()
        {
            ...
            List<Item> items = Configuration.Instance.GetItemConfigurations(LiveChartsPluginDefinition.LiveChartsPluginPluginId, null, _kind);
            return items;
        }
        ...
        {
            List<Item> items = Configuration.Instance.GetItemConfigurations(LiveChartsPluginDefinition.LiveChartsPluginPluginId, parentItem, _kind);
            return items;
        }
        ...
        {
            Item item = Configuration.Instance.GetItemConfiguration(LiveChartsPluginDefinition.LiveChartsPluginPluginId, _kind, fqid.ObjectId);
            return item;
        }
