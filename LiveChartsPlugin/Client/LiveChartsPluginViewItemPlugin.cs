...
namespace LiveChartsPlugin.Client
{
    ...
    /// </summary>
    public class LiveChartsPluginViewItemPlugin : ViewItemPlugin
    {

        public LiveChartsPluginViewItemPlugin()
        {
        }
        ...
        {
            get { return LiveChartsPluginDefinition.LiveChartsPluginViewItemPlugin; }
        }
        ...
        {
            return new LiveChartsPluginViewItemManager();
        }
