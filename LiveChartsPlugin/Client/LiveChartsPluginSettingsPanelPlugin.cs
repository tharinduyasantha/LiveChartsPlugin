...
{
    public class LiveChartsPluginSettingsPanelPlugin : SettingsPanelPlugin
    {
        ...
        {
            get { return LiveChartsPluginDefinition.LiveChartsPluginSettingsPanel; }
        }

        /// <summary>
        /// Should return the title of this plug-in. It will be displayed in the Settings panel navigation list.
        /// </summary>
        public override string Title { get { return "LiveChartsPlugin"; } }
        ...
        {
            _userControl = new LiveChartsPluginSettingsPanelControl(this);
            return _userControl;
        }
