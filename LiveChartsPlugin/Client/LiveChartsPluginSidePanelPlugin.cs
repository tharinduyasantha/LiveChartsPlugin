...
namespace LiveChartsPlugin.Client
{
    ...
    /// </summary>
    public class LiveChartsPluginSidePanelPlugin : SidePanelPlugin
    {
        /// <summary>
        ...
        //{
        //	return new LiveChartsPluginSidePanelUserControl();
        //}
        ...
        {
            return new LiveChartsPluginSidePanelWpfUserControl();
        }
        ...
        {
            get { return LiveChartsPluginDefinition.LiveChartsPluginSidePanel; }
        }
        ...
        {
            get { return "LiveChartsPlugin Side panel"; }
        }
